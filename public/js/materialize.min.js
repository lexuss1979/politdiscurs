    ...
    var e = {
        ...
        return _inherits(i, Component), _createClass(i, [{
            ...
            key: "_scroll", value: function (t) {
                document.querySelectorAll('.carousel-item.big').forEach((item) => {item.classList.remove('big')});
                var e = this;
                ...
                var koef, i, n, s, o, a = void 0, r = void 0, l = void 0, h = void 0, d = void 0, u = void 0, c = this.center,
                ...
                for (a = 1; a <= i; ++a) {
                    koef = a > 2 ? p: 0.06;
                    if (this.options.fullWidth ? (h = this.options.dist, d = a === i && n < 0 ? 1 - o : 1) : (h = this.options.dist * (2 * a + o * s), d = 1 - koef * (2 * a + o * s)), !this.noWrap || this.center + a < this.count) {
                    ...
                    if (this.options.fullWidth ? (h = this.options.dist, d = a === i && 0 < n ? 1 - o : 1) : (h = this.options.dist * (2 * a - o * s), d = 1 - koef * (2 * a - o * s)), !this.noWrap || 0 <= this.center - a) {
                        r = this.images[this._wrap(this.center - a)];
